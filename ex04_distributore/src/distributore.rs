...
use crate::states::{StatoDistributore, InAttesaCarta, CartaAccettata};
...
impl DistributoreAutomatico {
    ...
    /// Solo per i test: bypassa il lancio moneta e forza lo stato CartaAccettata.
...
pub(crate) fn lancio_moneta() -> bool {
